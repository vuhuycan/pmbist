...
add wave -noupdate -expand -group golden /mbist_tb/ax
add wave -noupdate -expand -group golden /mbist_tb/ay
add wave -noupdate -expand -group golden /mbist_tb/d
add wave -noupdate -expand -group golden /mbist_tb/q
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/bg_data_type
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/bg_data_inv
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/addr_x_cmd
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/addr_y_cmd
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/apply_addr_reg
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/no_last_addr_count
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/rpt_cntr_cmd
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/next_inst_cond_x
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/next_inst_cond_y
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/next_inst_cond_rc
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/loop_mode
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/inv_bg_data
add wave -noupdate -expand -group INS_FETCH /mbist_tb/DUT/inv_addr_seq
add wave -noupdate -group {addr regs} -radix hexadecimal /mbist_tb/DUT/r_addr_ax_reg
add wave -noupdate -group {addr regs} -radix hexadecimal /mbist_tb/DUT/r_addr_ay_reg
add wave -noupdate -group {addr regs} -radix hexadecimal /mbist_tb/DUT/r_addr_bx_reg
add wave -noupdate -group {addr regs} -radix hexadecimal /mbist_tb/DUT/r_addr_by_reg
add wave -noupdate -expand -group flowCTRL /mbist_tb/DUT/loop_reg_id
add wave -noupdate -expand -group flowCTRL /mbist_tb/DUT/repeat_en
...
add wave -noupdate -expand -group uCode /mbist_tb/DUT/addr_x_op_m1
...
WaveRestoreCursors {{Cursor 1} {188897 ps} 0} {{Cursor 2} {76892 ps} 1}
...
update
WaveRestoreZoom {15359364 ps} {15486350 ps}
