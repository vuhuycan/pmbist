...
add wave -noupdate -expand -group INS_FETCH /microcode_container/bg_data_type
add wave -noupdate -expand -group INS_FETCH /microcode_container/bg_data_inv
add wave -noupdate -expand -group INS_FETCH /microcode_container/addr_x_cmd
add wave -noupdate -expand -group INS_FETCH /microcode_container/addr_y_cmd
add wave -noupdate -expand -group INS_FETCH /microcode_container/apply_addr_reg
add wave -noupdate -expand -group INS_FETCH /microcode_container/no_last_addr_count
add wave -noupdate -expand -group INS_FETCH /microcode_container/rpt_cntr_cmd
add wave -noupdate -expand -group INS_FETCH /microcode_container/next_inst_cond_x
...
add wave -noupdate /microcode_container/r_addr_bx_reg
...
add wave -noupdate /microcode_container/r_addr_ay_reg
add wave -noupdate /microcode_container/r_addr_by_reg
